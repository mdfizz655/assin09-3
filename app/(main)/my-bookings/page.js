    ...
    <div className="py-10 px-4 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-gray-900">
          My Bookings <span className="text-blue-600 text-2xl">({bookings.length})</span>
        </h1>
      ...
      {bookings.length === 0 ? (
        <div className="text-center py-24 bg-white rounded-2xl border border-gray-100">
          ...
          <Link href="/cars" className="inline-block bg-blue-600 text-white text-sm px-8 py-3 rounded-xl font-bold hover:bg-blue-700">
            Explore Cars
          </Link>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {bookings.map((b) => (
            <div key={b._id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-all">
              ...
              <div className="p-5">
                ...
                <div className="flex justify-between items-center border-t border-gray-50 pt-4">
                  <span className="text-xl font-extrabold text-blue-600">
                    ${b.price}<span className="text-gray-400 text-xs font-normal">/day</span>
                  </span>
                  <button
